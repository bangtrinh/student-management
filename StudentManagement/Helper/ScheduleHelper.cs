...
namespace StudentManagement.Helpers
{
    public static class ScheduleHelper
    {
        public static int GetLessonStart(TimeSpan startTime)
        {
            ...
            else if (minutes >= baseTime15h05 && minutes < baseTime15h05 + 45 * 6)
                return 10 + (minutes - baseTime15h05) / 45;
        ...
        public static TimeSpan GetStartTimeFromLesson(int lesson)
        {
            switch (lesson)
            {
                ...
                case int n when n >= 10 && n <= 12:
                    return TimeSpan.FromMinutes(15 * 60 + 5 + (lesson - 10) * 45);
